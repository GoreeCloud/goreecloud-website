...
The authenticated GoreeCloud repository inventory currently contains **29 repositories: 22 public and 7 private**. The dedicated `repositories.html` page groups those repositories into **11 functional groups** and records a concise public description, purpose, role, visibility, and production boundary for each.
...
The portfolio includes Glaze UI; GoreeCloud Manager; GoreeCloud Identity; GoreeVault Server; Wardveil Security; Privacy Shield; GoreeCloud Backup; GoreeCloud Network, its dashboard source and Android client; GoreeCloud DNS; GoreeCloud Notes; GoreeCloud Memos; GoreeCloud Bookmarks and its browser extension; GoreeCloud Tasks; GoreeCloud Contacts; GoreeCloud Calendar; GoreeCloud Notify; GoreeCloud Monitor; GoreeCloud Search; GoreeCloud Feed; GoreeCloud Browser; GoreeCloud Redirector; GoreeCloud Source Resync; GoreeCloud Gallery; GoreeCloud Keyboard; GoreeCloud Changelogs; and this website.
