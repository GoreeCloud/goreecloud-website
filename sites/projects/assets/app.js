...
{name:'Glaze UI',repo:'goreecloud-glaze-ui',category:'Shared Foundations',model:'Design language',kind:'Foundation',status:'2.0.0 current Stable · Facet identity approved',role:'Official visual and interaction system for supported GoreeCloud surfaces, accessibility, semantic components, product consistency, and evidence-backed conformance. Facet is the current official identity; Glaze UI 2.1 remains Candidate and does not establish Stable consumer conformance.',visibility:'Public',icon:'/assets/glaze-ui-mark.svg',url:'https://design.goreecloud.com/'},
