...
{name:'Glaze UI',repo:'glaze-ui',category:'Shared Foundations',model:'Design language',kind:'Foundation',status:'1.4 current Stable · Fold identity approved',role:'Official visual and interaction system for mobile, tablet, desktop, TV, accessibility, semantic components, product consistency, and evidence-backed application conformance. The approved Fold mark is now the canonical Glaze UI visual identity; older consumer pins require controlled migration rather than production grandfathering.',visibility:'Public',icon:'/assets/glaze-ui-mark.svg',url:'https://design.goreecloud.com/'},
