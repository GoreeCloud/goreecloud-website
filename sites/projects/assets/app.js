...
{name:'GoreeCloud Mail',repo:'goreecloud-mail',category:'Communication & Media',model:'Native',kind:'Application',status:'Active development',role:'First-party email client for web, Linux, Android, and future iOS with Courier capabilities and provider-independent account architecture.',visibility:'Public'},
...
{name:'GoreeCloud Terminal',repo:'goreecloud-terminal',category:'Device Software',model:'Maintained fork',kind:'Application',status:'Active development',role:'Native Linux terminal for local shells, SSH administration, and GoreeCloud workstation workflows.',visibility:'Public'},
...
{name:'Glaze UI',repo:'glaze-ui',category:'Shared Foundations',model:'Design language',kind:'Foundation',status:'1.3 Stable · 1.4 candidate',role:'Official visual and interaction system for mobile, tablet, desktop, TV, accessibility, semantic components, and product consistency.',visibility:'Public',icon:'/assets/glaze-ui-mark.svg',url:'https://design.goreecloud.com/'},
...
{name:'Everkeep',repo:'goreecloud-everkeep',category:'Shared Foundations',model:'Resilience identity',kind:'Foundation',status:'Active',role:'Platform-wide resilience, backup and recovery, preservation, portability, succession, and digital-legacy identity.',visibility:'Public'}
];
